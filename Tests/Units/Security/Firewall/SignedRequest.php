...
{
    public function test_authenticate_invalid_signature_lead_to_exception(): void
    {
        $this
            ->given(
            ...
            ->exception(static function () use ($sut, $mockSignatureConfig, $mockReplayProtection): void {
    ...
    public function test_replay_protected_denied_lead_to_exception(): void
    {
        $this
            ->given(
                $mockSignatureConfig = new \mock\Rezzza\SecurityBundle\Security\Firewall\SignatureConfig(true, 'sha1', 's3cr3t'),
    ...
    public function test_it_should_authenticated_valid_signature_not_expired(): void
    {
        $this
            ->given(
                $mockSignatureConfig = new \mock\Rezzza\SecurityBundle\Security\Firewall\SignatureConfig(true, 'sha1', 's3cr3t'),
    ...
    public function test_signature_generated_with_replay_protection_should_not_be_the_same_without(): void
    {
        $this
            ->given(
